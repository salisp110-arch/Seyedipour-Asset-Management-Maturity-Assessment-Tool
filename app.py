...
# ---------------- Inject CSS/Font ONCE (no raw text!) ----------------
...
<style>
  ...
  html, body, [class*="css"] { font-family: var(--app-font) !important; direction: rtl; }
...
EMBEDDED_TOPICS = [
    ...
    {"id":40,"name":"نتایج و پیامدها","desc":"ترکیبی از خروجی‌ها و اثرات کوتاه/بلندمدت مالی/غیرمالی؛ چارچوب‌های Value Framework و 6 Capitals برای سنجش ارزش به‌کار می‌روند."},
]
...
with tabs[1]:
    ...
    # خلاصه مشارکت (تعداد و به تفکیک رده)
