...
# ---------------- استایل و فونت وزیر (یک‌تکه و امن) ----------------
st.markdown("""
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/rastikerdar/vazir-font@v30.1.0/dist/font-face.css">
<style>
:root{
  --brand:#16325c; --accent:#0f3b8f; --border:#e8eef7;
...
.question-card{
  ...
  box-shadow: 0 6px 16px rgba(36,74,143,0.06), inset 0 1px 0 rgba(255,255,255,0.6);
}
